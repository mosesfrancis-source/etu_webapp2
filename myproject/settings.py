...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-xu8i15=u-yzm#66l0ijnikj0bn7-vl38p#aq@!9s!&q27839&#'
)
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'math_dept_weppApp_db2'),
...
_default_storage = (
    'myproject.storage_backends.CloudinaryStorage'
    if CLOUDINARY_URL
